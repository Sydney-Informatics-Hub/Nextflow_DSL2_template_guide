...
Note the use of the `.view()` appended to the process inside the workflow in the `main.nf` file. The [view](https://www.nextflow.io/docs/latest/operator.html#view) operator prints items emitted by a channel to standard output.
:::
